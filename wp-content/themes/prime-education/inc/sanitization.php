...
function prime_education_sanitize_theme_width($input) {
...
function prime_education_sanitize_post_content_align($input) {
    // Define the valid options
...
/*------------------------------------------------------------------------*/
    ...
    function prime_education_sanitize_choicess($input) {
    $valid = array(
...
function prime_education_sanitize_post_layout($input) {
...
function prime_education_sanitize_scroll_top_alignment($input) {
...
function prime_education_sanitize_pagination_alignment($input) {
    $valid = array('right-align', 'center-align', 'left-align');
...
function prime_education_sanitize_sortable( $val, $setting ) {
