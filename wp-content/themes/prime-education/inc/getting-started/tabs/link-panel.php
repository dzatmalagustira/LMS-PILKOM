...
<div class="panel-right">
	<div class="panel-aside">
		<h4 class="heading"><?php esc_html_e( 'Upgrade To Pro Version', 'prime-education' ); ?></h4>
		<p class="panel-info">
			<?php
			echo wp_kses_post(
				__( 'Get Extra <span class="off">30% OFF</span>, Use Code <span class="code">“NY2026”</span> at the time of Checkout', 'prime-education' )
			);
			?>
		</p>
		<div class="pro-img">
			<img src="<?php echo esc_url(get_stylesheet_directory_uri()) .'/images/getstart-img.png'; ?>" alt="<?php echo esc_attr( 'screenshot', 'prime-education'); ?>"/>
		</div>
		<a class="button button-primary first-color" href="<?php echo esc_url( PRIME_EDUCATION_URL ); ?>" title="<?php esc_attr_e( 'View Premium Version', 'prime-education' ); ?>" target="_blank">
            <?php esc_html_e( 'Upgrade To Pro With Just $40', 'prime-education' ); ?>
        </a>
	</div>
	<div>
		<h4><?php esc_html_e( 'ABOUT THEME', 'prime-education' ); ?></h4>
