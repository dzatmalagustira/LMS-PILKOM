...
function prime_education_customize_register( $wp_customize ) {
    ...
    $wp_customize->register_control_type( 'Prime_Education_Control_Sortable' ); 
    ...
    $wp_customize->add_section(
        'prime_education_responsive_media_section',
        array(
            'title' => esc_html__( 'Responsive Media Settings', 'prime-education' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
            'panel' => 'prime_education_all_general_settings',
        )
    );

    /** Scroll to top Responsive control */
    $wp_customize->add_setting( 
        'prime_education_resp_scroll_top', 
        array(
            'default' => 1,
            'sanitize_callback' => 'prime_education_sanitize_checkbox',
        ) 
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'section'     => 'prime_education_responsive_media_section',
            'type'        => 'checkbox',
        )
    );
    ...
    //Global Color
    $wp_customize->add_section(
        'prime_education_global_color',
        array(
            'title' => esc_html__( 'Global Color Settings', 'prime-education' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
            'panel' => 'prime_education_all_general_settings',
        )
    ...
    $wp_customize->add_setting('prime_education_primary_color', array(
        'default'           => '#f2972e',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'prime_education_primary_color', array(
        'label'    => __('Theme Primary Color', 'prime-education'),
        'section'  => 'prime_education_global_color',
        'settings' => 'prime_education_primary_color',
    )));    

    $wp_customize->add_setting('prime_education_secondary_color', array(
        'default'           => '#632729',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'prime_education_secondary_color', array(
        'label'    => __('Theme Secondary Color', 'prime-education'),
        'section'  => 'prime_education_global_color',
        'settings' => 'prime_education_secondary_color',
    ))); 

    /** Post Layouts */

    $wp_customize->add_panel( 
        'prime_education_all_post_settings',
         array(
            'priority' => 10,
            'capability' => 'edit_theme_options',
            'title' => esc_html__( 'Post & Pages Settings', 'prime-education' ),
            'description' => esc_html__( 'Post & Pages Settings', 'prime-education' ),
        ) 
    );
    
    $wp_customize->add_section(
        'prime_education_post_layout_section',
        array(
            'title' => esc_html__( 'Post Layout Settings', 'prime-education' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
            'panel' => 'prime_education_all_post_settings',

        )
    );

    $wp_customize->add_setting('prime_education_post_layout_setting', array(
        'default'           => 'right-sidebar',
        'sanitize_callback' => 'prime_education_sanitize_post_layout',
    ));

    $wp_customize->add_control('prime_education_post_layout_setting', array(
        'label'    => __('Post Column Settings', 'prime-education'),
        'section'  => 'prime_education_post_layout_section',
        'settings' => 'prime_education_post_layout_setting',
        'type'     => 'select',
        'choices'  => array(        
            'right-sidebar'   => __('Right Sidebar', 'prime-education'),
            'left-sidebar'   => __('Left Sidebar', 'prime-education'),
            'one-column'   => __('One Column', 'prime-education'),
            'three-column'   => __('Three Columns', 'prime-education'),
            'four-column'   => __('Four Columns', 'prime-education'),
            'grid-layout'   => __('Grid Layout', 'prime-education')
        ),
    ));

    $wp_customize->add_setting('prime_education_archive_pagination_alignment',array(
        'default' => 'left-align',
        'sanitize_callback' => 'prime_education_sanitize_pagination_alignment'
    ));
    $wp_customize->add_control('prime_education_archive_pagination_alignment',array(
        'type' => 'select',
        'label' => __('Pagination Alignment','prime-education'),
        'section' => 'prime_education_post_layout_section',
        'choices' => array(
            'right-align' => __('Right Alignment','prime-education'),
            'center-align' => __('Center Alignment','prime-education'),
            'left-align' => __('Left Alignment','prime-education'),
        ),
    ) );
    ...
    $wp_customize->add_setting('prime_education_single_post_align',array(
        'default' => 'left-align',
        'sanitize_callback' => 'prime_education_sanitize_post_content_align'
    ));
    $wp_customize->add_control('prime_education_single_post_align',array(
        'type' => 'select',
        'label' => __('Post Content Alignment','prime-education'),
        'section' => 'prime_education_post_settings',
        'choices' => array(
            'left-align' => __('Left Alignment','prime-education'),
            'right-align' => __('Right Alignment','prime-education'),
    ...
    $wp_customize->add_setting('prime_education_blog_meta_order', array(
        'default' => array('heading', 'author', 'featured-image', 'content','button'),
        'sanitize_callback' => 'prime_education_sanitize_sortable',
    ));
    $wp_customize->add_control(new Prime_Education_Control_Sortable($wp_customize, 'prime_education_blog_meta_order', array(
        'label' => esc_html__('Post Meta Ordering', 'prime-education'),
        'description' => __('Drag & drop post items to rearrange the ordering ( this control will not function by post format )', 'prime-education') ,
        'section' => 'prime_education_post_settings',
        'choices' => array(
            'heading' => __('heading', 'prime-education') ,
            'author' => __('author', 'prime-education') ,
            'featured-image' => __('featured-image', 'prime-education') ,
            'content' => __('content', 'prime-education') ,
            'button' => __('button', 'prime-education') ,
        ) ,
    )));
    ...
    $wp_customize->add_section('prime_education_typography_settings', array(
        'title'      => esc_html__('Typography Settings', 'prime-education'),
        'priority'   => 30,
        'capability' => 'edit_theme_options',
        'panel' => 'prime_education_all_general_settings',
    ));
    ...
    $wp_customize->add_setting('prime_education_heading_font_family', array(
        'default'           => '',
        'sanitize_callback' => 'prime_education_sanitize_choicess',
    ));
    $wp_customize->add_control('prime_education_heading_font_family', array(
        'type'    => 'select',
        'choices' => $font_choices,
        'label'   => __('Select Font for Heading', 'prime-education'),
        'section' => 'prime_education_typography_settings',
    ));

    // Body Font Setting
    $wp_customize->add_setting('prime_education_body_font_family', array(
        'default'           => '',
        'sanitize_callback' => 'prime_education_sanitize_choicess',
    ));
    $wp_customize->add_control('prime_education_body_font_family', array(
        'type'    => 'select',
        'choices' => $font_choices,
        'label'   => __('Select Font for Body', 'prime-education'),
        'section' => 'prime_education_typography_settings',
    ));
    ...
    /** Home Page Settings */
    $wp_customize->add_panel( 
        'prime_education_all_general_settings',
         array(
            'priority' => 10,
            'capability' => 'edit_theme_options',
            'title' => esc_html__( 'General Settings', 'prime-education' ),
            'description' => esc_html__( 'General Settings', 'prime-education' ),
        ) 
    );
    ...
    $wp_customize->add_section(
        ...
        array(
            'title' => esc_html__( 'Loader Settings', 'prime-education' ),
            'priority' => 30,
            'capability' => 'edit_theme_options',
            'panel' => 'prime_education_all_general_settings',
        )
    ...
    /** Preloader control */
    $wp_customize->add_setting( 
        'prime_education_preloader_setting', 
        array(
            'default' => false,
            'sanitize_callback' => 'prime_education_sanitize_checkbox',
        ) 
    ...
    $wp_customize->add_setting('prime_education_menus_style',array(
        'default' => '',
        'sanitize_callback' => 'prime_education_sanitize_choices',
	));
	$wp_customize->add_control('prime_education_menus_style',array(
        'type' => 'select',
		'label' => __('Menu Hover Style','prime-education'),
		'section' => 'prime_education_header_section_settings',
		'choices' => array(
         'None' => __('None','prime-education'),
         'Zoom In' => __('Zoom In','prime-education'),
      ),
	));

    $wp_customize->add_setting('prime_education_theme_width',array(
        'default' => 'full-width',
        'sanitize_callback' => 'prime_education_sanitize_theme_width'
    ));
    $wp_customize->add_control('prime_education_theme_width',array(
        'type' => 'select',
        'label' => __('Theme Width Option','prime-education'),
        'section' => 'prime_education_general_settings',
        'choices' => array(
            'full-width' => __('Fullwidth','prime-education'),
            'container' => __('Container','prime-education'),
            'container-fluid' => __('Container Fluid','prime-education'),
        ),
    ) );
    ...
    $wp_customize->add_setting('prime_education_footer_widget_areas', array(
        'default'           => 4,
        'sanitize_callback' => 'prime_education_sanitize_choices',
    ));

    $wp_customize->add_control('prime_education_footer_widget_areas', array(
        'label'    => __('Footer Widget Columns', 'prime-education'),
        'section'  => 'prime_education_footer_section',
        'settings' => 'prime_education_footer_widget_areas',
        'type'     => 'select',
        'choices'  => array(
		   '1'     => __('One', 'prime-education'),
		   '2'     => __('Two', 'prime-education'),
		   '3'     => __('Three', 'prime-education'),
		   '4'     => __('Four', 'prime-education')
        ),
    ));
...
$wp_customize->add_setting('footer_background_image',
    ...
    $wp_customize->add_setting('prime_education_background_attatchment', array(
        'default'           => 'scroll',
        'sanitize_callback' => 'prime_education_sanitize_choices',
    ));

    $wp_customize->add_control('prime_education_background_attatchment', array(
        'label'    => __('Footer Background Attachment', 'prime-education'),
        'section'  => 'prime_education_footer_section',
        'settings' => 'prime_education_background_attatchment',
        'type'     => 'select',
        'choices'  => array(
            'fixed' => __('fixed','prime-education'),
            'scroll' => __('scroll','prime-education'),
        ),
    ));
    ...
    $wp_customize->add_setting('prime_education_scroll_top_alignment',array(
        'default' => 'right-align',
        'sanitize_callback' => 'prime_education_sanitize_scroll_top_alignment'
    ));
    $wp_customize->add_control('prime_education_scroll_top_alignment',array(
        'type' => 'select',
        'label' => __('Scroll Top Alignment','prime-education'),
        'section' => 'prime_education_footer_section',
        'choices' => array(
            'right-align' => __('Right Alignment','prime-education'),
            'center-align' => __('Center Alignment','prime-education'),
    ...
    $wp_customize->add_setting('prime_education_scroll_to_top_radius', array(
        'default'           => 'curved-box',
        'sanitize_callback' => 'prime_education_sanitize_choices',
    ));

    $wp_customize->add_control('prime_education_scroll_to_top_radius', array(
        'label'    => __('Scroll Top Button Shape', 'prime-education'),
        'section'  => 'prime_education_footer_section',
        'settings' => 'prime_education_scroll_to_top_radius',
        'type'     => 'select',
        'choices'  => array(
            'box'        => __( 'Box', 'prime-education' ),
            'curved-box' => __( 'Curved Box', 'prime-education' ),
            'circle'     => __( 'Circle', 'prime-education' ),
        ),
    ));
