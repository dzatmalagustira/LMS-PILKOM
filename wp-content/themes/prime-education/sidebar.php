...
<?php if ( ! is_active_sidebar( 'right-sidebar' ) ) { ?>
	...
	<aside id="secondary" class="widget-area wow zoomInUp delay-1000" data-wow-duration="2s" role="complementary">
		<!-- Search -->
		<aside id="search" class="widget widget_search" aria-label="<?php esc_attr_e( 'firstsidebar', 'prime-education' ); ?>">
		...
		<!-- Archive -->
		<aside id="archive" class="widget widget_archive" role="complementary" aria-label="<?php esc_attr_e( 'secondsidebar', 'prime-education' ); ?>">
		...
		<!-- Recent Posts -->
		<aside id="recent-posts" class="widget widget_recent_posts" role="complementary" aria-label="<?php esc_attr_e( 'thirdsidebar', 'prime-education' ); ?>">
		...
		<!-- Categories -->
		<aside id="categories" class="widget widget_categories" role="complementary" aria-label="<?php esc_attr_e( 'secondsidebar', 'prime-education' ); ?>">
